Config {
    ...
    commands = [
      Run Cpu [
        "--template", "<fc=#a9a1e1><fn=1>\xf2db</fn></fc>  <total>%",
        "-L", "3",
        "-H", "70",
        "--low", "gray",
        "--normal", "gray",
      ...
      Run Memory [
        "--template", "<fc=#51afef><fn=1>\xf538</fn></fc>  <usedratio>%",
        "-L", "10",
        "-H", "90",
        "--low", "gray",
        "--normal", "gray",
      ...
      Run Battery [
        ...
        "-A", "15",
        "--off-icon-pattern", "<fc=#B1DE76><fn=1>\xf240</fn></fc>",
        "--on-icon-pattern", "<fc=#B1DE76><fn=1>\xf0e7</fn></fc>",
        "--idle-icon-pattern", "<fc=#B1DE76><fn=1>\xf0e7</fn></fc>"
      ] 50,
